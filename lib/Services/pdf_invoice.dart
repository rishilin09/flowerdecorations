...
class PdfInvoice {
  ...
  static Future<File> generate(Invoice invoice) async{
    ...
    final List<Map<String,dynamic>> items = invoice.selectedItems.selectedItems;
    ...
    final invoiceNumber = '$occasionI$nameCode${date.day}${date.month}${date.year}';
  ...
  static pw.PageTheme _buildTheme(dateTime, invoiceNumber, payMethod, PdfPageFormat pageFormat, theme) =>
      pw.PageTheme(
        ...
        buildBackground: (context) => pw.FullPage(
            ignoreMargins: true, child: invoiceUI(dateTime, invoiceNumber, payMethod, 500.0, 720.0)),
      );
        ...
        pw.Positioned(
          ...
          child: pw.Container(
            ...
            decoration: pw.BoxDecoration(
                shape: pw.BoxShape.circle, color: PdfColor.fromHex('D91919')), //PdfColor.fromHex('02D1E1CC')
          ),
        ),
  ...
  static pw.Widget buildInvoice(double padding, List<Map<String, dynamic>> finalList) =>
      pw.Table(
  ...
  static pw.TableRow invoiceRows(
      double size, double padding, Map<String, dynamic> item, List<Map<String, dynamic>> finalList) =>
      pw.TableRow(children: [
        invoiceTexts('${item['title']}', size, padding, finalList.indexOf(item) == 0 ? true : false),
        invoiceTexts('${item['price']}', size, padding, finalList.indexOf(item) == 0 ? true : false),
      ]);
      ...
      children: [
        pw.Row(mainAxisAlignment: pw.MainAxisAlignment.end, children: [
          ...
          pw.Container(
              ...
              child:
              invoiceTexts('Rs.$total', 20.0, padding, true))
        ]),
      ]);
